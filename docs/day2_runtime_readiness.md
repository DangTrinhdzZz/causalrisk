...
The label-free smoke inference view has not been materialized. Live smoke-60
requires an explicit enablement decision plus the existing authorization and
artifact controls; dry-run does not grant either.
