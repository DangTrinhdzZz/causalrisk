...
- `amendment_008_r5_final_operational_compatibility.md`: frozen R4 failure lineage, NVIDIA protocol exclusion, and final R5 execution roster.
...
- `r4_operational_canary_forensic_aggregate.json`: label-free operational aggregate for the immutable failed R4 canary.
