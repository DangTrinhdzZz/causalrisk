...
def test_execution_preflight_passes_after_controlled_enablement():
    assert verify_r2_remediation_input(ROOT / "artifacts/runs")
    ...
    lineage_check = next(check for check in report.checks if check.name == "r2_immutable_remediation_lineage")
