"""Immutable artifact checksums and R1 remediation lineage checks."""
...
from causalrisk.execution_policy import R1_ARTIFACT_TREE_SHA256, R1_MANIFEST_SHA256, R1_RUN_ID
